...
task autonomous()
{
	motor[port2] = 127;
	motor[port5] = 82.5;
	wait1Msec(2620/(nImmediateBatteryLevel * 0.01/76.83));
	motor[port2] = 0;
	motor[port5] = 0;
	wait1Msec(250);
	motor[port2] = 127;
	motor[port5] = -127;
	wait1Msec(405/(nImmediateBatteryLevel * 0.01/76.83));
	motor[port2] = 0;
	motor[port5] = 0;
	wait1Msec(250);
	motor[port2] = 127;
	motor[port5] = 82.5;
	wait1Msec(1150/(nImmediateBatteryLevel * 0.01/76.83));
	motor[port2] = 0;
	motor[port5] = 0;
	wait1Msec(250);
	motor[port2] = -127;
	...
	motor[port2] = 127;
	motor[port5] = 82.5;
	wait1Msec(775/(nImmediateBatteryLevel * 0.01/76.83));
	motor[port2] = 0;
	motor[port5] = 0;
	wait1Msec(250);
	motor[port2] = -127;
